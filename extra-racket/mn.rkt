...
(define (stack-dot-product v1 v2)
  (if (or (null? v1) (null? v2))
      0
      (+ (* (car v1) (car v2)) (stack-dot-product (cdr v1) (cdr v2)))))

; recursivitate pe coada
(define (tail-dot-product v1 v2 [p 0])
  (if (or (null? v1) (null? v2))
      p
      (tail-dot-product (cdr v1) (cdr v2) (+ (* (car v1) (car v2)) p))))
...
(define (mult-matrix M1 M2)
  (map (curry matrix-vector (transpose M2)) M1))
